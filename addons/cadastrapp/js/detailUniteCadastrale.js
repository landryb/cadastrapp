        ...
        success : function(response) {
            ...
            if (result && result[0]) {
                ...
                fiucParcelleData = [ 
					...
					[ OpenLayers.i18n('cadastrapp.ficu.contenancedgfip'), result[0].dcntpa.toLocaleString(OpenLayers.Lang.getCode()) ], 
					[ OpenLayers.i18n('cadastrapp.ficu.contenancesig'), result[0].surfc.toLocaleString(OpenLayers.Lang.getCode()) ], 
